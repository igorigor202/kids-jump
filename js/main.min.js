      ...
      update: {
        ...
        updateSlides: function () {
          ...
          if (void 0 !== n) {
            ...
            if ((0 === v.length && (v = [0]), 0 !== s.spaceBetween)) {
              var ie,
                se = e.isHorizontal() && l ? "marginLeft" : t("marginRight");
        ...
        updateProgress: function (e) {
          ...
          0 === s
            ...
            S(t, { progress: r, isBeginning: n, isEnd: o }),
      ...
      updateSize: function () {
        ...
        if (e.params.scrollbar.el && e.scrollbar.el) {
          ...
          (s =
            ...
            S(t, { trackSize: r, divider: n, moveDivider: o, dragSize: s }),
            t.$el[
              e.params.watchOverflow && e.isLocked ? "addClass" : "removeClass"
...
var swiper = new Swiper(".games .swiper-container", {
  ...
  breakpoints: {
    ...
    1500: { width: "1570" },
    1440: { width: "1520" },
    1390: { slidesPerView: 3, width: "1075" },
    1200: { width: "1115" },
    1e3: { width: "1650" },
    700: { slidesPerView: 2, width: "675" },
    500: { slidesPerView: 2, width: "705" },
    320: { slidesPerView: 1, width: "310" },
  },
  navigation: {
...
function addSlider() {
  document
    .querySelector(".our__wrapper-right")
    .classList.add("swiper-container"),
    document
      .querySelector(".our__wrapper-block")
      .classList.add("swiper-wrapper"),
    document.querySelectorAll(".our__wrapper-card").forEach((e) => {
      e.classList.add("swiper-slide");
    });
  new Swiper(".our .swiper-container", {
    slidesPerView: 1,
    spaceBetween: 30,
    pagination: { el: ".our .swiper-pagination", type: "fraction" },
    navigation: {
...
document.querySelector("body").clientWidth <= 1100 && addSlider(),
    ...
    setTimeout(() => {
      menu.classList.add("header__menu-active"),
        ...
        (container.style.background =
          "linear-gradient(257.63deg, #342183 2.35%, #8228dc 98.49%)");
    }, 30);
}),
...
ourCard.forEach((e) => {
  e.addEventListener("click", () => {
    e.classList.contains("our__wrapper-card_active")
      ? e.classList.remove("our__wrapper-card_active")
      : e.classList.add("our__wrapper-card_active");
  });
});
